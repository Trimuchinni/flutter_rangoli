...
class _MugguState extends State<Muggu> {
  ...
  Widget build(BuildContext context) {
    Widget child = new CustomPaint(
      willChange: true,
      painter: new _PainterPainter(widget.painterController.pathHistory,
...
class PathHistory {
  ...
  bool get isEmpty => paths.isEmpty || (paths.length == 1 && _inDrag);
...
/// Used with a [Muggu] widget to control drawing.
class PainterController extends ChangeNotifier {
  ...
  /// Creates a new instance for the use in a [Muggu] widget.
  PainterController() : pathHistory = new PathHistory();
